...
public class CommonAPI {
    ...
    @BeforeMethod
    public static WebDriver setupDriver(String platform, String url, @Optional("chrome") String browser, @Optional("false") boolean cloud, @Optional("74") String browserVersion, @Optional("QA") String envName) throws MalformedURLException {
        if (cloud) {
    ...
    public static WebDriver getLocalDriver(String browser, String platform) {
        if (platform.equalsIgnoreCase("mac") && browser.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "/Users/movlonbek/IdeaProjects/webBootCampAoutomation/Generic/src/main/resources/driver/chromedriver 2");
        } else if (platform.equalsIgnoreCase("windows") && browser.equalsIgnoreCase("chrome")) {
            System.setProperty("webdriver.chrome.driver", "../Generic/src/main/resources/driver/chromedriver_win32.zip");
        }
